...
function action(a) {
  ...
  if (value === '') {
    ...
    let b64URL = getUrl();
    document.getElementById(getActiveFrameId()).src = "https://alloy123.herokuapp.com/fetch/" + getUrl();
  } else {
    let b64URL = getUrl();
    document.getElementById(getActiveFrameId()).src = "https://alloy123.herokuapp.com/fetch/" + getUrl();
  }
...
function inspect() {
  (function () { var script = document.createElement('script'); script.src = 'js/inspect.js'; script.className = 'webxray'; script.setAttribute('data-lang', 'en-US'); script.setAttribute('data-baseuri', 'https://alloy123.herokuapp.com/fetch/_aHR0cHM6Ly94LXJheS1nb2dnbGVzLm1vdXNlLm9yZw==_/'); document.body.appendChild(script); }())
}
function opencity(a) {
